...
int main()
{
	...
	while (true)
	{
		...
		// 유저가 게임 접속 종료! (types.h 에 #define _STOMP을 통해
		// StompAllocator 적용후 실행하면 WorkerThreadMain 콜백함수에서 크래시가 나는것을 확인할 수 있음)
